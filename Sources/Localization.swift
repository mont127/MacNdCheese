...
enum Localization {
    static let zh: [String: String] = [
        ...
        "D3DMetal isn't set up": "D3DMetal 尚未设置",
        "Copying D3DMetal…": "正在复制 D3DMetal…",
        "Apple ships D3DMetal in the Game Porting Toolkit and we can't include it. Point us at your copy and we'll install it.": "D3DMetal 由 Apple 随 Game Porting Toolkit 提供，我们无法随附。请指向你的副本，我们会自动安装。",
        "Choose folder…": "选择文件夹…",
        "Select your D3DMetal redist folder": "选择你的 D3DMetal redist 文件夹",
        "Pick the redist folder from the Game Porting Toolkit (the one containing lib/external and lib/wine).": "请选择 Game Porting Toolkit 中的 redist 文件夹（包含 lib/external 与 lib/wine）。",
        "Could not install D3DMetal.": "无法安装 D3DMetal。",
